...
def parse_config(args) -> Dict[str, DetectorConfig]:
    ...
    if not args.detector:
        raise ValueError("No detector configurations provided. Use --detector or --config-json.")
...
def main():
    ...
    # Process the data
    integrated_patterns = integrate_multi(args.input_dir, args.output_dir, file_configs)
    
    print(f"Integration completed. {len(integrated_patterns)} patterns saved to {args.output_dir}")
